...
#data$CU_grade_1st_sem_clean <- winsorize(data$CU_grade_1st_sem_clean)
#data$CU_grade_2nd_sem_clean <- winsorize(data$CU_grade_2nd_sem_clean)
...
# Creare un dataset solo con le variabili di interesse
pca_data <- data %>%
...
# Mostrare il grafico a schermo
print(scree_plot)

# Salvare il grafico in PDF (assicurati che la cartella "Grafici" esista)
ggsave("Grafici/ScreePlot_PCA.pdf", plot = scree_plot, width = 8, height = 6)

# Stampare le prime righe del dataset con le nuove componenti
head(data_pca)
