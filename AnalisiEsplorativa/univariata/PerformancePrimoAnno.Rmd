...
min_x <- 0
max_x <- 20
binwidth_value <- 1  # Bin più piccoli
breaks_seq <- seq(min_x, max_x, by = binwidth_value)  # Forza i break precisi
...
hist_density_1st <- ggplot(data, aes(x = `Curricular_units_1st_sem_(grade)`)) +
  geom_histogram(aes(y = ..density..), 
                 ...
                 boundary = min_x) +  # Assicura che il bin 0 venga visualizzato
